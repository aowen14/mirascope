...
class WeaviateVectorStore(BaseVectorStore):
    ...
    # Temporary function to allow for proper testing
    def exists(self, uuid: str) -> bool:
        return self._index.data.exists(uuid)
    ...
    # Temporary function to allow for proper testing, specifically to create the index
